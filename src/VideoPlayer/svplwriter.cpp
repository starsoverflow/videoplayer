...
namespace Star_VideoPlayer
{
	...
	BOOL svplwriter::WritePlayListToFile(wstring filepath, const svpl * m_svpl)
	{
		...
		fs << L"# Generated by svplwriter\n# Version: 1.0\n# If you want to modify this file, please delete all the lines above, \n# and then svplwriter will refuse to rewrite your playlist.\n";

		fs << L"# normalplaylist=" << m_svpl->config.normalplaylist << L"\n";
		fs << L"# mousehidetime=" << m_svpl->config.mousehidetime << L"\n";
		fs << L"# alwaystop=" << (m_svpl->config.alwaystop ? L"true" : L"false") << L"\n";
